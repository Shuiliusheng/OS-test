...
void console_runcmd(sCONSOLEINFO *cons, char *cmdline, uint *fat, uint memtotal)
{
	if(strcmp(cmdline,"mem")==0){
		...
		/*struct SEGMENT_DESCRIPTOR *gdt=(struct SEGMENT_DESCRIPTOR *) ADR_GDT;
		set_segmdesc(gdt + 102, 2*1024*1024, 0xbac444, AR_CODE32_ER+0x60);
		sprintf(str,"raw:0x%x,%d,0x%x,%d",gdt + 102, 2*1024*1024, 0xbac444, AR_CODE32_ER+0x60);
		show_string(str,32);
		expand_segment(102, 1000);*/
