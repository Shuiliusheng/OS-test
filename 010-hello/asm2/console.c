	...
	if(info!=0){
		...
		if(gdt_code!= 0 && gdt_data!=0){
			...
			*((int *)ADR_CODE)=(int)code;
			...
			set_segmdesc(gdt + gdt_code/8, info->size-1, (int)code, AR_CODE32_ER);
			
			set_segmdesc(gdt + gdt_data/8, 64*1024-1, (int)data, AR_DATA32_RW);
			...
			start_app(0, gdt_code, 64*1024, gdt_data);
